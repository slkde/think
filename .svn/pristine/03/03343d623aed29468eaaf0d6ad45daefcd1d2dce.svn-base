...
+ function(a) {
	...
	var b = {
		...
		initLayout: function(c) {
			...
			b.ui.windowWidth && a("#bjui-window").width(c), b.windowWidth = c, a("#bjui-container").height(e), a("#bjui-navtab").width(d), a("#bjui-leftside, #bjui-sidebar, #bjui-sidebar-s, #bjui-splitBar, #bjui-splitBarProxy").css({
				height: "100%"
			}), a("#bjui-navtab .tabsPageContent").height(e - f), setTimeout(function() {
		...
		resizePageH: function() {
			return this.each(function() {
				if (!a(this).closest(".tab-content").length) {
					var b = a(this),
						c = b.find("> .bjui-pageHeader"),
						d = b.find("> .bjui-pageContent"),
						e = b.find("> .bjui-pageFooter"),
						f = c.outerHeight() || 0,
						g = e.outerHeight() || 0;
...
+ function(a) {
	...
	function c(c) {
		...
		return this.each(function() {
			var f = a(this),
				g = a.extend({}, f.data(), "object" == typeof c && c),
...
+ function(a) {
	...
	a(function() {
		...
		var b = this,
			c = b.$bar.outerWidth() + 4,
			d = BJUI.windowWidth - a("#bjui-sidebar").width() - 6;
		b.faLock(), b.hoverLock(), b.$sbar.animate({
			left: -10
		}, 20), b.$bar.removeClass("shadown"), b.isfloat = !1, b.$navtab.animate({
			left: c,
			width: d
		}, 500, function() {
		...
		var b = this,
			c = 0 - b.$bar.outerWidth() - 0,
			d = BJUI.windowWidth - 6;
		b.faUnLock(), b.hoverUnLock(), b.$navtab.animate({
			...
			b.$sbar.animate({
				left: 0
			}, 200), b.$split.hide(), a(window).trigger(BJUI.eventType.resizeGrid)
		}), b.isfloat = !1
	}, b.prototype.float = function() {
		var a = this;
		a.$sbar.animate({
			left: -10
		}, 200), a.$bar.addClass("shadown").animate({
			left: 0
		}, 500), a.isfloat = !0
	}, b.prototype.hideFloat = function() {
		var a = this,
			b = 0 - a.$bar.outerWidth() - 0;
		a.$bar.animate({
			left: b - 10
		}, 500, function() {
			a.$sbar.animate({
		...
		var b = a("#bjui-hnav-navbar-box"),
			c = b.find("> #bjui-hnav-navbar"),
			d = b.prev(),
			e = b.next();
		d.hover(function() {
			c.stop().animate({
			...
			c.stop().animate({
				left: b.width() - b.data("hnav.liw") - 10
			}, 2e3, function() {
				e.hide()
			})
		}, function() {
		...
		var f, g, h, i, b = this,
			c = b.$element.text().trim(),
			d = b.$element.parent(),
			e = a("#bjui-accordionmenu");
		...
		var d = a(this).parent(),
			e = a("#bjui-accordionmenu"),
			f = d.data("bjui.slidebar.hnav.panels");
...
+ function(a) {
	...
	function f(b) {
		...
		return this.each(function() {
			var f = a(this),
				g = a.extend({}, e.DEFAULTS, f.data(), "object" == typeof b && b),
...
+ function(a) {
	...
	function p(b) {
		...
		return this.each(function() {
			var e = a(this),
				f = a.extend({}, o.DEFAULTS, "object" == typeof b && b),
			...
			l = {
				...
				visibleEnd: function() {
					var d, a = this.getLeft(),
						...
						c = this.getTabs();
					for (d = 0; d < c.size(); d++)
						if (b += c.eq(d).outerWidth(!0), b + a > this.getScrollBarW()) return d;
					return c.size()
				},
				scrollPrev: function() {
				...
				switchTab: function(e) {
					var f = this.getTabs().removeClass("active").eq(e).addClass("active"),
						g = this.getPanels(),
						h = g.eq(e),
						i = j.options.onSwitch ? j.options.onSwitch.toFunc() : null;
...
+ function(a) {
	...
	function g(b) {
		...
		return this.each(function() {
			var e = a(this),
				g = a.extend({}, f.DEFAULTS, "object" == typeof b && b),
	...
	a(function() {
		...
		if (b && "string" == typeof b)
			for (d = b.split(","), e = 0; e < d.length; e++) f = a("body").data(d[e].trim()), f && (f.removeData("bjui.clientPaging"), this.tools.reload(f));
		else c.removeData("bjui.clientPaging"), this.tools.reload(c)
	}, f.prototype.reload = function(b, c) {
		var g, h, i, d = this,
			e = a.extend({}, "object" == typeof b && b),
		...
		e = "n" == d || "nw" == d ? parseInt(c.css("top")) - g : h - parseInt(c.css("height")), 0 > g && (g = 0), c.css({
			...
			width: i + 2,
			height: h + 1
		}).find("> .dialogContent").css("width", i - 10), "w" != d && "e" != d && (j = c.find("> .dialogContent"), j.css({
...
+ function(a) {
	...
	function l(b) {
		...
		return this.each(function() {
			var e = a(this),
				f = a.extend({}, k.DEFAULTS, e.data(), "object" == typeof b && b),
		...
		var k = {
			...
			visibleEnd: function() {
				var c, a = this.getLeft(),
					b = this.getTasks();
				for (c = 0; c < b.size(); c++)
					if (b.eq(c).position().left + b.eq(c).outerWidth(!0) + a > this.getBarWidth()) return b.eq(c);
...
+ function(a) {
	...
	function d(b) {
		...
		return this.each(function() {
			var f = a(this),
				g = a.extend({}, c.DEFAULTS, f.data(), "object" == typeof b && b),
	...
	c.DEFAULTS = {
		reload: !0,
		loadingmask: !0
	}, c.NAVTAB = "navtab", c.prototype.TOOLS = function() {
		var b = this,
			d = {
				getPagerForm: function(b, c) {
					var f, g, d = b.isTag("form") ? b[0] : b.find("#pagerForm:first")[0],
						e = a.extend({}, BJUI.pageInfo);
					if (b.data("bjui.clientPaging") && (c = a.extend({}, b.data("bjui.clientPaging"), c), b.data("bjui.clientPaging", c)), d)
						for (f in e) g = "", c && c[f] && (g = c[f]), d[e[f]] ? g && (d[e[f]].value = g) : a('<input type="hidden" name="' + e[f] + '" value="' + g + '">').appendTo(a(d));
					return d
				},
				getTarget: function() {
		...
		var e = this,
			g = (e.$element, d.target ? a(d.target) : null);
		...
		if (a && "string" == typeof a)
			for (b = a.split(","), c = 0; c < b.length; c++) this.refreshLayout({
				target: "#" + b[c]
			})
		...
		var e = this,
			...
			g = {
				...
				openPosition: function() {
					var a = BJUI.alertMsg.displayPosition,
						c = BJUI.alertMsg.displayMode,
						d = 460,
						e = b.outerHeight(),
						g = {},
						h = {};
					...
					"slide" == c ? b.css(g).show().animate(h, 500) : "fade" == c ? (g.opacity = .1, b.css(g).css(h).show().animate({
						opacity: 1
					}, 500)) : b.css(g).css(h).show()
				},
				closePosition: function() {
					var d = BJUI.alertMsg.displayPosition,
						e = BJUI.alertMsg.displayMode,
						g = 460,
						h = b.outerHeight(),
						i = {};
				...
				open: function(g, h, i) {
					var l, m, o, p, q, r, j = this,
						k = "",
						n = BJUI.alertMsg.alertTimeout;
					if (i)
						for (o = 0; o < i.length; o++) p = i[o].call ? "callback" : "", q = i[o].cls ? i[o].cls : "default", r = i[o].cls && "green" == i[o].cls ? "check" : "close", k += FRAG.alertBtnFrag.replace("#btnMsg#", '<i class="fa fa-' + r + '"></i> ' + i[o].name).replace("#callback#", p).replace("#class#", q);
					l = a(FRAG.alertBoxFrag.replace("#type#", g).replace("#fa#", f.fas[g]).replace("#title#", this.getTitle(g)).replace("#message#", h).replace("#btnFragment#", k)).hide().appendTo("body"), b && b.length && b.remove(), b = l, j.openPosition(), d && (clearTimeout(d), d = null), null == f.mask && f.types.info != g && f.types.correct != g && c.show(), null == f.autoClose && (f.types.info == g || f.types.correct == g) && (n ? f.alertTimeout && 3e3 != f.alertTimeout && (n = f.alertTimeout) : n = f.alertTimeout, d = setTimeout(function() {
						...
						}, e)), i[b].keyCode == BJUI.keyCode.ENTER && a(document).on("keydown.bjui.alertmsg.ok", {
							target: m.eq(b)
						}, j.keydownOk), i[b].keyCode == BJUI.keyCode.ESC && a(document).on("keydown.bjui.alertmsg.esc", {
							target: m.eq(b)
						}, j.keydownEsc)
					})
				},
...
+ function(a) {
	...
	function c(c) {
		...
		return this.each(function() {
			var f = a(this),
				g = a.extend({}, b.DEFAULTS, f.data(), "object" == typeof c && c),
...
+ function($) {
	...
	function parseDate(a, b) {
		...
		for (a += "", b += "", c = 0, d = 0, e = "", f = "", j = new Date(1900, 0, 1), k = j.getYear(), l = j.getMonth() + 1, m = 1, n = j.getHours(), o = j.getMinutes(), p = j.getSeconds(), q = ""; d < b.length;) {
			...
			if ("yyyy" == f || "yy" == f || "y" == f) {
				...
				for (l = 0, r = 0; r < MONTH_NAMES.length; r++)
					if (s = MONTH_NAMES[r], a.substring(c, c + s.length).toLowerCase() == s.toLowerCase() && ("MMM" == f || "NNN" == f && r > 11)) {
						l = r + 1, l > 12 && (l -= 12), c += s.length;
						break
					}
				if (1 > l || l > 12) return 0
			} else if ("EE" == f || "E" == f) {
				for (r = 0; r < DAY_NAMES.length; r++)
					if (t = DAY_NAMES[r], a.substring(c, c + t.length).toLowerCase() == t.toLowerCase()) {
						c += t.length;
						break
					}
			} else if ("MM" == f || "M" == f) {
	...
	Date.prototype.formatDate = function(a) {
		...
		var f, g, h, i, b = this.getFullYear(),
			c = this.getMonth() + 1,
			d = this.getDate(),
...
+ function(a) {
	...
	function u(b) {
		...
		return this.each(function() {
			var e = a(this),
				f = a.extend({}, t.DEFAULTS, e.data(), "object" == typeof b && b),
	...
	a(function() {
			...
			d = {
				...
				hasDate: function() {
					...
					for (b = 0; b < a.length; b++)
						if (-1 != c.options.pattern.indexOf(a[b])) return !0;
					return !1
				},
		...
		var u, v, w, x, y, z, A, g = this,
			...
			t = "";
		if (s > 0)
			for (r.setMonth(r.getMonth() - 1), u = q.getDateWrap(r), v = u.days - s + 1; v <= u.days; v++) w = new Date(d.year, d.month - 2, v), x = w >= e && f >= w ? "" : " disabled", t += '<dd class="other' + x + '" data-month="-1" data-day="' + v + '">' + v + "</dd>";
...
+ function(d) {
	...
	c.prototype.TOOLS = function() {
		...
		var g = {
			...
			getPageInterval: function(j, l, n) {
				var k = Math.ceil(n / 2),
					i = j - n,
					m = l > k ? Math.max(Math.min(l - k, i), 0) : 0,
			...
			getRight: function(k) {
				var j = 0,
					i = k.data("index"),
					h = f.$tbody.find("> tr:first > td:lt(" + (i + 1) + ")");
				if (!h || !h.length) {
					h = f.$colgroupH.find("> col:lt(" + (i + 1) + ")")
				}
				h.each(function() {
					var m = d(this),
						l = m.is(":hidden") ? 0 : m.outerWidth();
					j += l
				});
				return j
			},
			getRight4Lock: function(i) {
				var j = 0,
					k = f.$lockTbody.find("> tr:first > td:eq(" + i + ")"),
					h = k && k.prevAll().add(k);
				if (!h || !h.length) {
			...
			createTrs: function(i, h) {
				var n = this,
					l = f.columnModel,
					k = f.paging,
					m = BJUI.doRegional(FRAG.gridEditBtn, f.regional),
					j = [];
				if (h) {
				...
				d.each(i, function(q, o) {
					var r = d("<tr></tr>"),
						s, p = e.linenumberAll ? ((k.pageCurrent - 1) * k.pageSize + (q + 1)) : (q + 1);
					d.extend(o, {
						gridNumber: p,
						gridIndex: q
					});
					d.each(l, function(w, u) {
						var t = u.name || "datagrid-noname",
							B = o[t],
							z = "",
							D = "",
							C;
			...
			createThead: function() {
				...
				d.each(p, function(t, s) {
					var w = d('<tr style="height:25px;"></tr>'),
						v = '<th class="datagrid-number"></th>',
						u;
			...
			showSubMenu: function(p, i, o) {
				var k, j = i.outerWidth(),
					m = o.data("width") || o.outerWidth(),
					l, n = f.$boxH.width();
			...
			locking: function(o) {
				var m = o.data("index"),
					...
					h = f.$menu,
					j = h.find("> ul"),
					i = j.find("> li." + f.classnames.li_lock),
					p = i.next();
				if (k) {
					i.addClass("disable");
					...
					d.each(f.columnModel, function(j, m) {
						...
						var l = function(i) {
							k.click(function() {
								...
								var p = d(this),
									n = !p.find("i").hasClass("fa-check-square-o"),
									o = i.index;
			...
			getRemoteFilterData: function(i) {
				...
				h.push({
					name: BJUI.pageInfo.pageSize,
					value: f.paging.pageSize
				});
				h.push({
					name: BJUI.pageInfo.pageCurrent,
					value: f.paging.pageCurrent
				});
				return h
			},
			setDomData: function(l) {
				var j = f.columnModel,
					k = {},
					i = l.attr("data-hidden-datas"),
					h = f.attach;
				l.find("> td").each(function(n) {
					var p = d(this),
						m = j[n],
						o = p.attr("data-val") || p.text();
					if (!m.name) {
	...
	c.prototype.setColumnModel = function() {
		...
		if (f.length && l == 1) {
			...
			f.find("> th").each(function(o) {
				var p = d(this).addClass("single-row"),
					q = p.data("options"),
					m = p.attr("width") || p.outerWidth(),
					n = p.html();
			...
			f.each(function(n) {
				...
				d(this).height(25).find("> th").each(function(u) {
					var z = d(this),
						v = z.data("options") || z.data("datagrid.column") || {},
						r = parseInt(z.attr("colspan") || 0),
						t = parseInt(z.attr("rowspan") || 0),
						w = z.attr("width") || z.outerWidth(),
						y = z.html();
	...
	c.prototype.destroy = function() {
		var f = this,
			e = f.$grid.data("bjui.datagrid.table");
		if (e) {
	...
	c.prototype.initTop = function() {
		var i = this,
			...
			g = i.regional,
			k = false,
			l, h = '<div class="btn-group" role="group"></div>',
	...
	c.prototype.initThead = function() {
		...
		k.filter(".datagrid-column-menu").on("bjui.datagrid.th.filter", function(q, n) {
			var o = d(this),
				p = o.find("> div > ." + j.classnames.th_cell + "> ." + j.classnames.btn_menu + "> .btn");
			if (n) {
	...
	c.prototype.initEvents = function(f) {
		...
		f.on("click.bjui.datagrid.tr", function(p, o) {
			var n = d(this),
				l = n.index(),
				k = h.$tbody.find("> tr." + h.classnames.tr_selected),
				j = h.$lastSelect,
				m, i = h.$lockTbody && h.$lockTbody.find("> tr");
			if (o) {
				m = o.is(":checked");
				if (!m) {
					h.$lastSelect = n
	...
	c.prototype.selectedRows = function(i, g) {
		var h = this,
			e = h.$lockTbody && h.$lockTbody.find("> tr"),
			f = h.$tbody.find("> tr"),
			k;
		var j = function(l) {
	...
	c.prototype.fixedLockItem = function(h) {
		var i = this,
			g = i.columnModel,
			e = i.$thead.find("> tr.datagrid-filter > th"),
	...
	c.prototype.doLock = function() {
		...
		var p = n.$lockTableH.height(),
			q = n.$thead.height(),
			j = n.$lockTableF && n.$lockTableF.height(),
		...
		h = n.$tbody.find("> tr");
		setTimeout(function() {
			var u = n.$lockTableB.height(),
				t = n.$tableB.height();
			if (u != t) {
				if (u > t) {
					i.each(function(w) {
						var v = d(this),
							y = v.find("> td:visible:first"),
							x = y.outerHeight();
						if (x > 30) {
							v.height(x);
							h.eq(w).height(x)
	...
	c.prototype.showLinenumber = function(l) {
		...
		if (m == k.linenumberColumn) {
			...
			if (l) {
				var f = k.$thead.find("> tr"),
					e = '<col style="width:30px;">',
					n, j = f.filter(".datagrid-filter"),
					g = f.length - j.length;
	...
	c.prototype.showCheckboxcol = function(n) {
		...
		if (h) {
			...
			if (n) {
				var g = m.$thead.find("> tr"),
					f = '<col style="width:26px;">',
					p, e, l = g.filter(".datagrid-filter"),
					i = g.length - l.length;
				h = m.checkboxColumn;
	...
	c.prototype.showEditCol = function(n) {
		...
		if (m == l.editBtnsColumn) {
			...
			if (n) {
				var g = l.$thead.find("> tr"),
					f = '<col style="width:110px;">',
					o, e, k = g.filter(".datagrid-filter"),
					h = g.length - k.length;
				m = l.editBtnsColumn;
				j.push(m);
	...
	c.prototype.colResize = function() {
		...
		e.find("> tr > th").each(function(j) {
			var k = d(this),
				l = k.find("> div > ." + g.classnames.th_cell + "> ." + g.classnames.th_resizemark);
			l.on("mousedown.bjui.datagrid.resize", function(u) {
				var v = g.$boxH.scrollLeft(),
					q = parseInt(g.$boxH.css("marginLeft") || 0),
					o = h.getRight(k) - v + q,
					t = k.data("index"),
					r = f[t],
					m = r.th.width(),
					n = g.$tbody.find("> tr"),
					p = g.$lockTbody && g.$lockTbody.find("> tr"),
					w = g.$lockTableB && g.$lockTableB.height(),
					y = g.$tableB.height(),
					x, s;
				g.isResize = true;
				if (r.locked) {
	...
	c.prototype.colMenu = function() {
		var i = this,
			...
			j = i.tools,
			h = i.regional,
			f = i.$trsH.find("> th." + i.classnames.th_menu),
		...
		f.each(function() {
			var n = d(this),
				m = n.data("index"),
				l = i.columnModel[m],
				p = n.find("> div > ." + i.classnames.th_cell),
				k = p.find("> ." + i.classnames.btn_menu),
				o;
			if (!k.length) {
				...
				o.click(function() {
					var z = n.closest("tr"),
						u = parseInt(n.attr("rowspan") || 1),
						q = d(this).offset().left - i.$grid.offset().left - 1,
						B = (i.$trsH.length - u) * 25 + (13 * u) + 11,
						A = g.find("> ul > li.datagrid-li-showhide"),
						v, t;
					...
					i.colFilter(n, true);
					j.locking(n);
					var w = g.find("> ul > li." + i.classnames.li_asc),
						x = w.next();
					w.click(function() {
						l.sortAsc = false;
						j.quickSort(l)
		...
		i.$grid.on("click.bjui.datagrid.filter", function(m) {
			var k = d(m.target),
				l = i.$grid.find("." + i.classnames.s_menu + ":visible");
		...
		if (z) {
			...
			if (!t || !t.length) {
				...
				var m = g.data("index"),
					...
					h = j.type || "string",
					o = j.operator || [],
					E = t.find("span.filter-a"),
					D = t.find("span.filter-b"),
					w = d('<select data-toggle="selectpicker" data-container="true"></select>'),
					e = d(n.inputs[m]),
					x, v;
				...
				var p = t.find("button.ok"),
					k = t.find("button.clear"),
					A = t.find("select"),
					r = A.first(),
					q = A.last(),
					s = A.eq(1);
	...
	c.prototype.initPaging = function() {
		...
		j.$box_paging.initui();
		var p = j.$btnpaging.find("> li.page-jumpto"),
			B = p.next(),
			y = B.next(),
			z = j.$btnpaging.find("> li.page-next"),
			o = z.next();
		var l = function() {
			B.addClass("disabled");
			y.addClass("disabled")
		...
		j.$paging.on("click", ".page-num", function(C) {
			...
			var F = j.paging.pageCurrent,
				C = x.getPageInterval(j.paging.pageCount, F, h.showPagenum),
				E = [];
	...
	c.prototype.add = function(p) {
		...
		var m = this,
			...
			n, i = {},
			j = [],
			k, o = (f.pageCurrent - 1) * f.pageSize,
			g;
		var e = function(s) {
			var t = d("<tr></tr>").addClass(m.classnames.tr_add),
				r = t.clone();
			...
			return {
				tr: t,
				lockTr: r.find("> td").length ? r : null
			}
		};
		if (!p) {
	...
	c.prototype.doCancelEditRow = function(g) {
		...
		e.each(function() {
			var i = d(this),
				h = i.find("> td." + f.classnames.s_edit + " > button.cancel");
			if (h.length) {
				h.trigger("click")
			} else {
				f.cancelEdit(i)
			...
			if (m) {
				...
				m = function(p) {
					...
					if (d.type(p) == "array") {
						...
						f.each(function(r) {
							var s = d(this),
								t = k.isDom ? s.data("initData") : k.data[s.index()];
			...
			h.isValid(function(n) {
				if (n) {
					...
					h.bjuiajax("doAjax", {
						url: m.editUrl,
						data: {
							json: JSON.stringify(e.push(g) && e)
						},
						type: "POST",
						callback: l
					})
	...
	c.prototype.cancelEdit = function(e) {
		...
		e.each(function() {
			...
			if (l.hasClass(g.classnames.tr_add)) {
				var m = false,
					i = l.data(g.datanames.changeData);
	...
	c.prototype.inlineEditComplete = function(i, h, m) {
		...
		d.each(j, function(r, u) {
			...
			if (u.render && typeof u.render == "function") {
				...
				var o = k.$lockTbody.find("> tr:eq(" + l + ")"),
					q = o.find("> td:eq(" + u.lockIndex + ")");
	...
	c.prototype.dialogEdit = function(j, r, g) {
		...
		var n = function(z) {
			var y = z.find("form.datagrid-dialog-edit-form"),
				x = z.find("div.bjui-pageFooter button"),
				w = x.first(),
				u = x.eq(1),
				B = x.eq(2),
				v = x.last();
			var A = function(E, C, D) {
				...
				d.each(k, function(G, J) {
					...
					var I = d(l.inputs[G]),
						F = d("<p></p>"),
						H = "datagrid-dialog-edit-column-" + G;
					if (I.isTag("select")) {
		...
		var p = function() {
			l.$tbody.find("> tr." + l.classnames.tr_add).each(function() {
				var y = false,
					x = d(this),
					u = x.data(l.datanames.changeData);
...
+ function(a) {
	...
	b.SCROLLW = 18, b.DEFAULTS = {
		...
		var g, h, i, j, k, l, m, n, o, c = this.options.styles = [],
		...
		this.$element, g = 0, h = [], i = [], j = -1, e.each(function(b) {
			...
			var c, d, f, g, h, i, k;
			if (b = parseInt(b), b > 1)
				for (c = parseInt(e.eq(a).attr("colsnum")), d = b - 1; d >= 0; d--) f = m.eq(j++), g = c - d, h = f.attr("width"), i = f.attr("align"), k = l.find("> th").eq(g), f && f.length && f.attr("colsnum", g), h && k.attr("width", h), i && f.addClass(i).removeAttr("align")
		...
		var c = this,
			d = function() {
				a("div.bjui-resizeGrid").each(function() {
					var k, d = a(this),
						e = d.closest(".navtabPage"),
						f = d.width(),
						g = d.height(),
						h = d.find(".bjui-tablefixed"),
						i = h.find(".fixedtableThead").height(),
						j = c.options.newWidth;
			...
			d = {
				...
				initTbody: function() {
					...
					d.find("> tr").each(function() {
						...
						var i, j, e = a(this).closest("tr"),
							g = e.index(),
							h = c.options.callback;
			...
			c = {
				changeVal: function(c) {
					var d = a.$element,
						...
						h = a.options.max,
						i = a.options.step;
					1 == f ? h - i >= e && (e += i) : -1 == f ? e >= g + i && (e -= i) : e > h ? e = h : g > e && (e = g), a.options.decimalPlace && (e = new String(e.toFixed(a.options.decimalPlace))), a.ivalue = e, d.val(e).trigger(b.EVENTS.afterChange, {
						value: e
					})
				}
			};
	...
	e.DEFAULTS = {
		...
		d.data("customEvent") ? d.trigger("customEvent.bjui.lookup", [b]) : g.find(":input").each(function() {
			var i, j, d = a(this),
				g = d.attr("name");
			for (i in b)
				if (j = f.getField(i), j == g) {
					h = 1 == c ? d.val() ? d.val() + "," + b[i] : b[i] : b[i], d.val(h).trigger(e.EVENTS.afterChange, {
						value: b[i]
					});
					break
				}
		...
		var c = this,
			...
			e = {
				...
				keyUp: function(b) {
					...
					switch (b.which) {
						...
						case BJUI.keyCode.ENTER:
							...
							if (j = !1, k = !1, l = null, m = c.$menu && c.$menu.find("> ." + d.lightCls), m && m.length) j = m.text(), l = m.data("item"), k = l.value;
							else {
				...
				createTag: function(b, d) {
					var f, e = a('<span class="label label-tag" data-value="' + d + '" style="margin-left: 1px; margin-top: 1px;"><i class="fa fa-tag"></i> ' + b + '&nbsp;&nbsp;<a href="#" class="close">&times;</a></span>');
...
+ function(a) {
		...
		var c = this,
			...
			e = {
				...
				filter: function(b) {
					...
					if (f.length > 0)
						for (g = 0; g < b.length; g++) h = b[g], parseInt(this.formatFileSize(h.size, !0)) > d.fileSizeLimit ? c.$element.alertmsg("error", '文件"' + h.name + '"大小超出限制！') : a.inArray(h.name.split(".").pop().toLowerCase(), f) >= 0 ? e.push(h) : c.$element.alertmsg("error", '文件"' + h.name + '"类型不允许！');
					return e
				},
				getFiles: function(a) {
				...
				sendBlob: function(a, b, c, e) {
					...
					if (b.open(d.method, a, !0), b.setRequestHeader("X-Requested-With", "XMLHttpRequest"), f.append(d.fileObjName, c), e)
						for (g in e) f.append(g, e[g]);
					b.send(f)
				}
			};
		return e
	...
	}, b.prototype.destroy = function() {}, d = a.fn.upload, a.fn.upload = c, a.fn.upload.Constructor = b, a.fn.upload.noConflict = function() {
...
+ function(a) {
	...
	function e(b) {
		...
		return this.each(function() {
			var f = a(this),
				g = a.extend({}, d.DEFAULTS, f.data(), "object" == typeof b && b),
				h = f.data("bjui.theme");
...
+ function(a) {
	...
	b.DEFAULTS = {}, b.prototype.init = function() {
		...
		c.find("> .bjui-maskProgress").find(".progress").stop().animate({
			width: "85%"
		}, "fast"), e.each(function() {
			var c = a(this),
				e = {};
		...
		var c = a(b.target),
			...
			e = c.find("> .bjui-pageContent").find("form");
		...
		var f = e(a(b.target));
		f.$bg.fadeIn(), f.$pr.fadeIn(), f.$pr.find(".progress").animate({
			width: "80%"
		}, c || 500), d && setTimeout(function() {
			d.toFunc().call(this)
		}, 25)
		...
		c.one("ajaxStart", function() {
			d.$bg.fadeIn(), d.$pr.fadeIn(), d.$pr.find(".progress").animate({
				width: "10%"
			}, "fast")
		}).one("ajaxStop", function() {}).one("ajaxError", function() {
	...
	}, a(document).on(BJUI.eventType.beforeLoadDialog, function() {}).on(BJUI.eventType.beforeAjaxLoad, function(b) {
		f(a(b.target))
	...
	a(document).on(BJUI.eventType.initUI, function(b) {
		...
		d.each(function() {
			...
			b.find("> .panel").length && (c || d) && (e(c, d), a(window).resize(function() {
				...
				var c = a(this).find("> .panel:last"),
					d = c.find("> .panel-heading > h4 > a");
			...
			}), require(["echarts", "echarts/theme/" + d, "echarts/chart/" + e[0], e[1] ? "echarts/chart/" + e[1] : "echarts"], function(d, e) {
				var f = d.init(b[0], e);
				a.get(c.url, function(a) {
//					console.dir(a);
					f.setOption(a)
